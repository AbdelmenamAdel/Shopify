...
import 'package:shopify/core/common/widgets/custom_drop_down.dart';
...
import 'package:shopify/features/admin/products/presentation/widgets/create/create_product_images.dart';
...
class _CreateProductBottomSheetState extends State<CreateProductBottomSheet> {
  ...
  void _validCreateProductButton(BuildContext context) {
    final imageList = context.read<UploadImageCubit>().imageList;
    final indexEmptyImage = imageList.indexWhere((e) => e.isNotEmpty);

    // final isImageListEmpty =
    ...
    if (fromKey.currentState!.validate()) {
      ...
      ShowToast.showToastErrorTop(message: 'Please fill all fields');
    }
  }
}
