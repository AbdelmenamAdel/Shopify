...
import 'package:shopify/core/enums/filter_button_enum.dart';
...
import 'package:shopify/features/customer/search/presentation/widgets/save_filter_button.dart';
import 'package:shopify/features/customer/search/presentation/widgets/search_for_data_icon.dart';
import 'package:shopify/features/customer/search/presentation/widgets/search_name_price_button.dart';
                    ...
                    context.read<SearchBloc>().add(
                          SearchEvent.searchProduct(
                            body: SearchRequestBody(
                              searchName: null,
                              priceMin:
                                  int.parse(priceMinController.text.trim()),
                              priceMax:
                                  int.parse(priceMaxController.text.trim()),
                            ),
                          ),
                        );
                    setState(() {
