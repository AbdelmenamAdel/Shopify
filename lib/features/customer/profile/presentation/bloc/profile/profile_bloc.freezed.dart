...
class __$$GetUserDataEventImplCopyWithImpl<$Res>
    extends _$ProfileEventCopyWithImpl<$Res, _$GetUserDataEventImpl>
...
abstract class GetUserDataEvent implements ProfileEvent {
...
class _$ErrorStateImpl implements ErrorState {
  const _$ErrorStateImpl({required this.errMsg});
  ...
  @override
  String toString() {
    return 'ProfileState.error(errMsg: $errMsg)';
  }
...
abstract class ErrorState implements ProfileState {
  const factory ErrorState({required final String errMsg}) = _$ErrorStateImpl;
