...
import 'package:shopify/features/customer/products_view_all/persentation/bloc/products_view_all/products_view_all_event.dart';
import 'package:shopify/features/customer/products_view_all/persentation/bloc/products_view_all/products_view_all_state.dart';
...
// Get All Proudtcs
      ...
      success: (data) {
        emit(
          ProductsViewAllSuccessState(
            productsList: data.getAllProductsList,
            hasMoreData: true,
          ),
        );
      },
  ...
  FutureOr<void> _loadMoreProducts(
    ...
    result.when(
      success: (data) {
        final newList = [...state.productsList, ...data.getAllProductsList];
        emit(
          ProductsViewAllSuccessState(
            productsList: newList,
            hasMoreData: !(data.getAllProductsList.length < 6),
          ),
        );
      },
      failure: (error) {
